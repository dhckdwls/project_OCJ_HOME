...
<c:set var="pageTitle" value="TEST MAP"></c:set>
<%@ include file="../common/head2.jspf"%>



<main style="text-align: center;">
	<div id="container" class="view_map" style="height: 800px;">
    <div id="mapWrapper" style="width:100%;height:800px;position:relative;">
        <div id="map" style="width:100%;height:100%"></div> <!-- 지도를 표시할 div 입니다 -->
        <input type="button" id="btnRoadview" onclick="toggleMap(false)" title="로드뷰 보기" value="로드뷰">
    </div>
    <div id="rvWrapper" style="width:100%;height:800px;position:absolute;top:0;left:0;">
...
<button onclick="setZoomable(false)" class="btn btn-outline">지도 확대/축소 끄기</button>
	<button onclick="setZoomable(true)" class="btn btn-outline">지도 확대/축소 켜기</button>
</main>
